...
| WhatsApp Community Care (broadcast, re-engagement, ulang tahun) | `arsitektur-wa-community-care.md` | 🟢 Selesai | — |
| WhatsApp AI Chatbot (bot donasi, intent routing, flow transaksi) | `arsitektur-wa-bot.md` | 🟢 Selesai | — |
