// Category utility functions that are safe for client-side use
// Separated from categories.ts to avoid importing database dependencies
...
// Get category label from value - safe for client-side
