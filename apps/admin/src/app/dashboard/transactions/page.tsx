    ...
    <div className="dashboard-container">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-600 mt-1">Semua transaksi dari berbagai tipe produk</p>
        </div>
        <button
          type="button"
      ...
      <div className="filter-container">
        <div className="filter-group">
          <Autocomplete
            ...
            onChange={handleFilterChange(setProductTypeFilter)}
        ...
        {isEmptyState ? (
          ...
          transactions.map((transaction: any) => (
            <div key={transaction.id} className="table-card">
              ...
              <div className="table-card-row">
                <span className="table-card-row-label">Produk</span>
