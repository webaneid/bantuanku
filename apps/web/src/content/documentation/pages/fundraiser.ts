...
export const fundraiserDoc: DocumentationPage = {
    ...
    summary:
        "Panduan mengelola influencer: pendaftaran, kode referral, tracking komisi, dan pencairan.",
    ...
    sections: [
        {
            ...
            bodyHtml:
                ...
                '</ul>' +
                '<img src="/docs/screenshot-fundraisers.png" alt="Halaman Influencer" style="width:100%; border-radius:8px; border:1px solid #e5e7eb; margin:16px 0;" />' +
                '<p><em>Tampilan halaman influencer pada admin panel — menampilkan kode, nama, tipe, status, total referral, total donasi, dan komisi.</em></p>',
        },
        {
            id: "alur-pendaftaran",
            ...
            bodyHtml:
                ...
                '<li>Buka menu Akun / Profil lalu pilih <strong>Influencer</strong>.</li>' +
                '<li>Klik tombol daftar/pengajuan sebagai Influencer.</li>' +
        ...
        },
        {
            ...
            bodyHtml:
                '<p>Setiap influencer mendapatkan <strong>kode unik</strong> berformat <code>FRS62XXXXX</code> (contoh: FRS6200001).</p>' +
                '<p>Cara kerja referral:</p>' +
                '<ol>' +
                '<li>Influencer membagikan link dengan parameter <code>?ref=FRS6200001</code> ke program tertentu.</li>' +
                ...
                '</ol>' +
                '<p>Influencer bisa melihat daftar program aktif yang tersedia untuk dishare (campaign, zakat, qurban).</p>',
        },
        {
            id: "komisi",
            ...
            bodyHtml:
                ...
                '<tbody>' +
                '<tr><td style="padding:10px; border:1px solid #e5e7eb;">Persentase Komisi</td><td style="padding:10px; border:1px solid #e5e7eb;">Disesuaikan oleh admin, bisa diatur secara global maupun per influencer</td></tr>' +
                ...
                '<tr><td style="padding:10px; border:1px solid #e5e7eb;">Pencegahan Transaksi Sendiri</td><td style="padding:10px; border:1px solid #e5e7eb;">Jika donatur yang berdonasi adalah orang yang <strong>sama</strong> dengan influencer pemilik link, maka status referral akan dilewati (tidak dapat komisi)</td></tr>' +
                '</tbody></table>' +
                '<p>Tracking per influencer:</p>' +
                '<ul>' +
        ...
        },
        {
            ...
            bodyHtml:
                '<p>Influencer bisa mengajukan pencairan komisi:</p>' +
                '<ol>' +
                '<li>Buka halaman <strong>Influencer Portal</strong> (website) atau <strong>Influencer Saya</strong> (admin).</li>' +
        ...
        },
        {
            ...
            bodyHtml:
                ...
                '</tbody></table>' +
                '<p>Admin bisa mengubah status influencer kapan saja dari halaman detail influencer.</p>',
        },
    ],
};
