    ...
    sections: [
        {
            ...
            bodyHtml:
                ...
                '</tbody></table>' +
                '<p>💡 <strong>Penting:</strong> Seluruh potongan (developer, fundraiser, mitra) diambil dari <strong>bagian amil</strong>, bukan dari dana program/mustahiq. Dana program selalu utuh sesuai persentase yang ditetapkan.</p>',
        },
        {
            id: "aturan-syariat",
        ...
        },
        {
            ...
            bodyHtml:
                ...
                '├── Developer Fee = D × Developer%<br/>' +
                '├── Fundraiser = D × Fundraiser% <span style="color:#6b7280;">(jika via referral)</span><br/>' +
                '├── Mitra = D × Mitra% <span style="color:#6b7280;">(jika campaign/zakat mitra)</span><br/>' +
                '└── <strong>Sisa Amil = Bagian Amil - Developer - Fundraiser - Mitra</strong><br/><br/>' +
        ...
        },
        {
            ...
            bodyHtml:
                ...
                '├── Developer (2.5%) = Rp 125.000<br/>' +
                '├── Fundraiser (3%) = Rp 150.000 (jika via referral)<br/>' +
                '├── Mitra = Rp 0<br/>' +
        ...
        },
        {
            ...
            bodyHtml:
                ...
                '</tbody></table>' +
                '<p>⚠️ <strong>Validasi penting:</strong> Pastikan total potongan (Developer% + Fundraiser% + Mitra%) <strong>tidak melebihi</strong> persentase amil (X%). Jika melebihi, sistem akan menolak dan menampilkan error.</p>',
        },
        {
            id: "kapan-dihitung",
        ...
        },
        {
            ...
            bodyHtml:
                ...
                '<li><strong>Total Developer Fee</strong> — Seluruh fee platform</li>' +
                '<li><strong>Total Komisi Fundraiser</strong> — Seluruh komisi fundraiser</li>' +
        ...
        },
        {
            ...
            bodyHtml:
                ...
                '<li>⚠️ <strong>Total potongan tidak boleh melebihi bagian amil</strong> — Jika Developer% + Fundraiser% + Mitra% > X%, sistem menolak. Hubungi admin settings.</li>' +
                ...
                '<li>⚠️ <strong>Transaksi refund/dibatalkan</strong> — Revenue share dibatalkan, saldo fundraiser dan mitra dikurangi otomatis.</li>' +
