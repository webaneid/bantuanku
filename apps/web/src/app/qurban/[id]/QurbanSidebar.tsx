...
export default function QurbanSidebar({
  ...
  const handleOrderClick = () => {
    if (!isAvailable) {
      alert('Paket ini sudah tidak tersedia');
      return;
    }
  ...
  return (
    <div className="sticky top-8 space-y-4">
      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
        ...
        {/* Price */}
        <div className="mb-4">
          <div className="text-sm text-gray-600 mb-1">Harga per {qurbanPackage.packageType === 'individual' ? 'ekor' : 'slot'}</div>
          ...
          {qurbanPackage.packageType === 'individual' ? (
            <div className="text-sm">
              ...
              <span className="font-semibold text-gray-900">
                {qurbanPackage.stock - qurbanPackage.stockSold} dari {qurbanPackage.stock} ekor
              </span>
            </div>
          ) : (
            <div className="text-sm space-y-1">
              <div>
                ...
                <span className="font-semibold text-gray-900">
                  {qurbanPackage.availableSlots} slot
                </span>
              </div>
              <div>
                <span className="text-gray-600">Max per hewan:</span>{' '}
                <span className="font-semibold text-gray-900">
                  {qurbanPackage.maxSlots} orang
                </span>
              </div>
            </div>
          )}
        ...
        {isAvailable ? (
          <div className="space-y-4">
            ...
            <div className="border-t border-gray-200 pt-4 space-y-2">
              ...
              <div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-600">Biaya Admin ({quantity}x)</span>
          ...
          <div className="text-center py-4">
            <p className="text-red-600 font-semibold mb-2">Stok Habis</p>
            <p className="text-sm text-gray-600">
              Paket qurban ini sudah tidak tersedia
            </p>
          </div>
        )}
      </div>
      ...
      <div className="bg-blue-50 rounded-lg p-4">
        ...
        <p className="text-sm text-blue-700 mb-3">
          Hubungi kami untuk informasi lebih lanjut tentang qurban.
        </p>
      ...
      <QurbanConfirmModal
        ...
        orderData={{
          ...
          periodName: periods.find((p) => p.id === selectedPeriod)?.name || 'Periode Qurban',
          quantity,
        }}
        total={total}
