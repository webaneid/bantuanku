...
import { fetchZakatConfig, calculateZakatIncome, formatCurrency } from '@/services/zakat';
              ...
              <form onSubmit={handleCalculate} className="space-y-6">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    Gaji, honorarium, dan penghasilan tetap bulanan
                  </p>
                </div>
                ...
                <div>
                  ...
                  />
                  <p className="mt-1 text-sm text-gray-500">
                    Bonus, tunjangan, atau penghasilan tambahan lainnya
                  </p>
                </div>
                ...
                <div>
                  ...
                  />
                  <p className="mt-1 text-sm text-gray-500">
                    Biaya kebutuhan pokok, cicilan, dan pengeluaran wajib lainnya (opsional)
                  </p>
                </div>
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <div className="flex justify-between items-center">
                    <span className="text-sm font-medium text-gray-700">Penghasilan Bersih</span>
                ...
                >
                  {calculating ? 'Menghitung...' : 'Hitung Zakat Penghasilan'}
                </button>
              </form>
            </div>
            ...
            <div>
              {result ? (
                <div className="bg-white rounded-xl border border-gray-200 p-6">
                  ...
                  <div className="space-y-4 mb-6">
                    ...
                    <div className="flex justify-between items-center pb-3 border-b border-gray-200">
                      <span className="text-gray-600">Nisab (per bulan)</span>
                  ...
                  {!result.isWajib && (
                    <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 text-sm text-amber-800">
                      Penghasilan Anda belum mencapai nisab. Namun, Anda tetap dapat bersedekah sesuai kemampuan.
                    </div>
                  )}
                </div>
              ) : (
                <div className="bg-white rounded-xl border border-gray-200 p-6">
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-500">
                      Isi form di samping untuk menghitung zakat penghasilan
                    </p>
                  </div>
                </div>
              )}
              ...
              <div className="mt-6 bg-emerald-50 border border-emerald-200 rounded-lg p-6">
                ...
                <ul className="text-sm text-emerald-800 space-y-2">
                  <li>• Nisab zakat penghasilan setara dengan 85 gram emas per bulan</li>
